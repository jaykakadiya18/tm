...
IPROYAL_USER ="plural2356" or os.environ.get('IPROYAL_USER')
IPROYAL_PASS = "dorbu7r62t9k" or os.environ.get('IPROYAL_PW')
...
links=[
r"http://shop.axs.com/?c=axs&e=941670467197579905",
r"http://shop.axs.com/?c=axs&e=941670467196905006",
r"http://shop.axs.com/?c=axs&e=941670467196930159"]
  ...
  async def handle_response(self):
        ...
        while(self.inputs):   
           ...
           while((not (await locator.is_visible() or data))):
              if(tries>self.tries or ctime-time()>20):break
